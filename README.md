...
接收UDP消息并实时显示，一般这个程序会跑在性能较强的电脑上，不需要什么额外的东西
...
```c
cd C
gcc deh264.c -o deh264 $(pkg-config --cflags --libs libavcodec libavutil libavformat libswscale libswresample)
```

## cpp test

Warning: 开始前请在`cpp_opencv/CMakeLists.txt` 中设置 `OpenCV_DIR`
